  ...
  return (
    <div className="bg-[#e7fdfd] px-4 py-6 sm:px-8 md:px-16 lg:px-24 xl:px-32 space-y-12">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-green-700 text-xl font-bold mb-2">Our Mission</h2>
      ...
      <div className="max-w-7xl mx-auto">
        <h2 className="text-green-700 text-xl font-bold mb-2">Our Vision</h2>
        <p className="text-gray-800 text-base mb-6">
      ...
      <div className="max-w-7xl mx-auto">
        <h2 className="text-green-700 text-xl font-bold mb-2">Our Values</h2>
        <p className="text-gray-800 text-base mb-6">
